...
Use our [P-Statements Reference](https://ghspictograms.com/p-statements/) to look up all precautionary codes with full text, applicable hazard classes, and CLP Annex references.
...
- [H-Statements Reference →](https://ghspictograms.com/h-statements/)
